...
const navItems = [
  ...
  { to: '/plans/new', icon: FileText, label: 'Create Plan', roles: ['EMPLOYEE', 'TEAM_LEADER', 'DEPARTMENT_MANAGER', 'EXECUTIVE_MANAGER', 'CEO', 'BOARD_MEMBER'] },
  { to: '/reviews', icon: ClipboardCheck, label: 'Pending Reviews', roles: ['TEAM_LEADER', 'DEPARTMENT_MANAGER', 'EXECUTIVE_MANAGER', 'CEO', 'BOARD_MEMBER'] },
