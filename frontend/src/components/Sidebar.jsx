...
const navItems = [
  ...
  { to: '/plans/new', icon: FileText, label: 'Create Plan', roles: ['EMPLOYEE', 'DIVISION_MANAGER', 'DEPARTMENT_MANAGER', 'EXECUTIVE_MANAGER', 'CEO', 'BOARD_MEMBER'] },
  { to: '/reviews', icon: ClipboardCheck, label: 'Pending Reviews', roles: ['DIVISION_MANAGER', 'DEPARTMENT_MANAGER', 'EXECUTIVE_MANAGER', 'CEO', 'BOARD_MEMBER'] },
