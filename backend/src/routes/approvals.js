...
router.post('/:planId/approve', authenticate, authorize('TEAM_LEADER', 'DEPARTMENT_MANAGER', 'EXECUTIVE_MANAGER', 'CEO', 'BOARD_MEMBER'), async (req, res) => {
  try {
...
router.post('/:planId/reject', authenticate, authorize('TEAM_LEADER', 'DEPARTMENT_MANAGER', 'EXECUTIVE_MANAGER', 'CEO', 'BOARD_MEMBER'), [
...
router.post('/:planId/return', authenticate, authorize('TEAM_LEADER', 'DEPARTMENT_MANAGER', 'EXECUTIVE_MANAGER', 'CEO'), [
...
router.post('/:planId/submit', authenticate, async (req, res) => {
  try {
    ...
    const reviewerRoleMap = {
      'EMPLOYEE': 'TEAM_LEADER', 'TEAM_LEADER': 'DEPARTMENT_MANAGER',
    ...
    if (reviewerRole) {
      ...
      for (const reviewer of reviewers) {
        const shouldNotify = reviewerRole === 'TEAM_LEADER' && reviewer.id === req.user.managerId ||
          reviewerRole === 'DEPARTMENT_MANAGER' && reviewer.departmentId === req.user.departmentId ||
          !['TEAM_LEADER', 'DEPARTMENT_MANAGER'].includes(reviewerRole);
